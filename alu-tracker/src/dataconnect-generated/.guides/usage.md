...
```ts
import { useCreateApplication, useGetApplications, useUpdateApplicationStatus, useDeleteApplication } from '@dataconnect/generated/react';
// The types of these hooks are available in react/index.d.ts

const { data, isPending, isSuccess, isError, error } = useCreateApplication(createApplicationVars);

const { data, isPending, isSuccess, isError, error } = useGetApplications();

const { data, isPending, isSuccess, isError, error } = useUpdateApplicationStatus(updateApplicationStatusVars);

const { data, isPending, isSuccess, isError, error } = useDeleteApplication(deleteApplicationVars);
...
```js
import { createApplication, getApplications, updateApplicationStatus, deleteApplication } from '@dataconnect/generated';
...
// Operation DeleteApplication:  For variables, look at type DeleteApplicationVars in ../index.d.ts
